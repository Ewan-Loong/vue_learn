  ...
  <div class="standard-table-container">
    ...
    <div class="table-wrapper" ref="tableWrapperRef">
      <a-table
          ...
          size="small"
          table-layout="fixed"
          :scroll="{ y: tableMaxHeight, x: true }"
      ...
      >
        <template #bodyCell="{ column, record }">
          ...
          <template v-else>
            <div
                class="cell-wrap"
                :title="formatCellContentFull(record[column.dataIndex])"
            >
              {{ formatCellContentDisplay(record[column.dataIndex]) }}
            </div>
          </template>
        </template>
      </a-table>
    ...
    <div class="table-bottom-slot" v-if="$slots.bottom">
      <slot name="bottom" :data="paginatedData" :pagination="innerPagination" :filtered-data="filteredData"></slot>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    formatCellContentDisplay(value) {
